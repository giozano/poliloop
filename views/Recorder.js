...
export default function Recorder(props) {
  ...
  let transportBar = requestAnimationFrame(function cursorMove() {
    //
    let cursorPosition = Tone.Transport.progress * 100 + "%";
    let angularPosition =
      (Tone.Transport.progress % (1 / state.bars)) * state.bars * 360 + "deg";
    ...
    document.getElementById("circle-looped").style.transform =
      "rotate(" + angularPosition + ")";
